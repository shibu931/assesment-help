                    ...
                    <div className="row">
                        <div className="col-lg-5">
                            <ul className="top-contact text-left">
                                <li><i className="fas fa-phone" />&nbsp;&nbsp;<a to="callto:+447882466599">+44 7882 466599</a></li>
                                <li><i className="far fa-envelope" />&nbsp;&nbsp;< a to="mailto:info@thestudenthelpline.com">info@example.com</ a></li>
                            </ul>
                        </div>
                    ...
                    <div className="site-header-menu">
                        <div className="container-xl">
                            ...
                            <a className="home-link" href={process.env.PUBLIC_URL + '/'} title="Altech" rel="home">
                                <img id="logo-img" className="img-fluid" alt="logo" src="./images/logo.webp" />
                            </a>
                            </div>
                            {/* site-branding end*/}
                            {/*site-navigation */}
